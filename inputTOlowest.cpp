...
C员工业绩录入Dlg::C员工业绩录入Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(C员工业绩录入Dlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void C员工业绩录入Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(C员工业绩录入Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &C员工业绩录入Dlg::OnBnClickedButton1)
END_MESSAGE_MAP()


// C员工业绩录入Dlg 消息处理程序

BOOL C员工业绩录入Dlg::OnInitDialog()
{
...
void C员工业绩录入Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR C员工业绩录入Dlg::OnQueryDragIcon()
{
...
void C员工业绩录入Dlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	CString name;
	CString id;
